...
"""@iot_bp.route('/api/user/<username>', methods = ['GET'])
def get_user_by_username(username):
        return UserController.get_user_by_username(username)"""

@iot_bp.route('/api/user', methods = ['POST'])
def create_user():
...
@iot_bp.route('/api/sensor/get_sensorData_by_time_interval', methods = ['GET'])
def get_sensorData_by_time_interval():
        return SensorController.get_sensorData_by_time_interval()